...
export function AnalysesTable({ data }: TableSortProps) {
    ...
    const rows = sortedData.map((row) => (
        <tr key={row._id}>
            <td>{row.name}</td>
            <td>{row.analysismethod_id}</td>
            <td>{row.tags}</td>
            <td>{row.upstream.length}</td>
            <td>{row.downstream.length}</td>
            ...
            >
                <thead>
                    <tr>
                        ...
                        <Th
                            sorted={sortBy === 'analysismethod_id'}
                            reversed={reverseSortDirection}
                            onSort={() => setSorting('analysismethod_id')}
                        >
                            Actor
                        </Th>
                        <UnsortableTh>
