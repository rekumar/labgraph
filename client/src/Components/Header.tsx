    ...
    return (
        <header>
            <div className="content-desktop">
                <div>
                    <Badge size="lg" radius={10} color="blue">ALab Data</Badge>
                </div>
                <div className="navbar">
                    ...
                    <Button color="blue" onClick={() => redirectToLink('https://github.com/rekumar/alab_data')}>Check out ALab Data</Button>
                </div>
            </div>
                ...
                >
                    <div className="menu">
                        ...
                        <div className="menu-items">
                            ...
                            <Anchor href="mailto:rekumar@lbl.gov">
                                rekumar@lbl.gov
                            </Anchor>
                        </div>
                        {/* 
